...
import { IAppResponse, ServiceCadDTO } from '@app/shared-types';
...
export async function SaveServiceController(_event: IpcMainInvokeEvent, service: ServiceCadDTO): Promise<IAppResponse> {
  try {
